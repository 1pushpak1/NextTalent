...
export default function PrivacyPolicyPage() {
  const sections = [
    ...
    },
    {
      ...
      content: (
        <>
          <p>We may use trusted third-party service providers, including but not limited to:</p>
          <ul className="list-disc space-y-2 pl-5 text-left">
            <li>Stripe (payment processing)</li>
            <li>Sterling (background verification)</li>
            <li>Hosting and technical infrastructure providers</li>
          </ul>
          <p>These third parties may process information only as necessary to provide services connected to our operations.</p>
        </>
      ),
    },
    {
