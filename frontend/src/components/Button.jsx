export default function Button({ children, className = '', variant = 'primary', ...props }) {
  const variants = {
    ...
    adminPrimary:
      'bg-[#c8a96b] text-black border border-[#c8a96b] hover:-translate-y-0.5 hover:bg-[#d4b87e] hover:border-[#d4b87e] hover:shadow-[0_0_24px_rgba(200,169,107,0.3)]',
    adminSecondary:
      'bg-white text-[#111318] border border-[rgba(200,169,107,0.38)] hover:-translate-y-0.5 hover:bg-[#fffaf1] hover:shadow-[0_0_22px_rgba(200,169,107,0.14)]',
    adminGhost:
      'bg-transparent text-[#c8a96b] border border-[rgba(200,169,107,0.26)] hover:-translate-y-0.5 hover:bg-[rgba(200,169,107,0.1)]',
  };
